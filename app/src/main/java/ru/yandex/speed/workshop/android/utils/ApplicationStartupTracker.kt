...
class ApplicationStartupTracker
    ...
    constructor(
            ...
            currentStartupType =
                when {
                    ...
                    lastBackgroundTimestamp > 0 &&
                        (currentTime - lastBackgroundTimestamp < WARM_START_THRESHOLD_MS) -> StartupType.WARM_START
         ...
         */
        fun recordPhaseTimestamp(
            phase: StartupPhase,
            timestamp: PerformanceTimestamp = PerformanceTimestamp.now(),
        ) {
